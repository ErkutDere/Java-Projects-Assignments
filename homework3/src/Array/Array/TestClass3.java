...
public class TestClass3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("There is/are " + gizemsungu.getOutboxNum() + " message(s) in the outbox.");
        System.out.println("Checking inbox...");
        System.out.println("There is/are " + gizemsungu.getInboxNum() + " message(s) in the inbox.");
        ...
        gizemsungu.login();
        System.out.println("blocks sibelgulmez...");
        gizemsungu.block(sibelgulmez);
        System.out.println("gizemsungu logs out...");
        System.out.println("sibelgulmez logs in...");
        sibelgulmez.login();
        System.out.println("tries to view the profile of gizemsungu...");
        sibelgulmez.viewProfile(gizemsungu);
        System.out.println("tries to send a message to gizemsungu...");
        Message message2 = new Message(1, sibelgulmez, gizemsungu, "Are you at school right now?");
        sibelgulmez.logout();
